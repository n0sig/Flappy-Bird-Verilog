...
HD_PWD='C:/Users/yhszj/Desktop/FlappyBird/FlappyBird.runs/SpeedUpROM_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SpeedUpROM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SpeedUpROM.tcl
