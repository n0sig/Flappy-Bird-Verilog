...
HD_PWD='C:/Users/yhszj/Desktop/FlappyBird/FlappyBird.runs/ScoreNumberROM_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ScoreNumberROM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ScoreNumberROM.tcl
