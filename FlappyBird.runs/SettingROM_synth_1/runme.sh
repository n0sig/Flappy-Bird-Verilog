...
HD_PWD='C:/Users/yhszj/Desktop/FlappyBird/FlappyBird.runs/SettingROM_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SettingROM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SettingROM.tcl
