...
HD_PWD='C:/Users/86187/Desktop/FlappyBird/FlappyBird.runs/LogoROM_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log LogoROM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source LogoROM.tcl
