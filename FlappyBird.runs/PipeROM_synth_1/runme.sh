...
HD_PWD='C:/Users/86187/Desktop/FlappyBird/FlappyBird.runs/PipeROM_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PipeROM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PipeROM.tcl
