...
HD_PWD='C:/Users/yhszj/Desktop/FlappyBird/FlappyBird.runs/ScoreboardROM_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ScoreboardROM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ScoreboardROM.tcl
